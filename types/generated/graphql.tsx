...
export type GetUseIdsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUseIdsQuery = (
  { __typename?: 'query_root' }
  & { users: Array<(
    { __typename?: 'users' }
    & Pick<Users, 'id'>
...
export const GetUseIdsDocument = gql`
    query GetUseIds {
  users(order_by: {created_at: desc}) {
    id
  }
...
/**
 * __useGetUseIdsQuery__
 *
 * To run a query within a React component, call `useGetUseIdsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUseIdsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUseIdsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetUseIdsQuery(baseOptions?: Apollo.QueryHookOptions<GetUseIdsQuery, GetUseIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUseIdsQuery, GetUseIdsQueryVariables>(GetUseIdsDocument, options);
      }
export function useGetUseIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUseIdsQuery, GetUseIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUseIdsQuery, GetUseIdsQueryVariables>(GetUseIdsDocument, options);
        }
export type GetUseIdsQueryHookResult = ReturnType<typeof useGetUseIdsQuery>;
export type GetUseIdsLazyQueryHookResult = ReturnType<typeof useGetUseIdsLazyQuery>;
export type GetUseIdsQueryResult = Apollo.QueryResult<GetUseIdsQuery, GetUseIdsQueryVariables>;
